...
from context_loader import load_context_file, load_all_context, get_learner_profile, get_misconception_context, get_combined_context
from a2ui_templates import get_system_prompt, FLASHCARD_EXAMPLE, AUDIO_EXAMPLE, VIDEO_EXAMPLE, SURFACE_ID
passed = 0
failed = 0
...
def test_surface_id():
    assert SURFACE_ID == 'portfolioContent', f"SURFACE_ID should be 'portfolioContent', got {SURFACE_ID}"
...
def test_video_example():
    ...
    assert 'youtube' in VIDEO_EXAMPLE
...
if AGENT_AVAILABLE:
    ...
    def test_audio_components():
        ...
        required = {'audioCard', 'audioContent', 'audioHeader', 'audioIcon', 'audioTitle', 'audioPlayer', 'audioDescription'}
