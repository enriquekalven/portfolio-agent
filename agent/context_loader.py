...
def load_all_context() -> dict[str, str]:
    ...
    """
    context_files = ['01_maria_learner_profile.txt', '02_chemistry_bond_energy.txt', '03_chemistry_thermodynamics.txt', '04_biology_atp_cellular_respiration.txt', '05_misconception_resolution.txt', '06_mcat_practice_concepts.txt']
    context = {}
