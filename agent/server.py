...
app = FastAPI(title='Personalized Learning Agent', description='A2A agent for generating personalized A2UI learning materials', version='0.1.0')
...
async def get_capabilities():
    ...
    return {'name': 'Personalized Learning Agent', 'description': 'Generates personalized A2UI learning materials', 'supported_formats': LearningMaterialAgent.SUPPORTED_FORMATS, 'extensions': [{'uri': 'https://a2ui.org/a2a-extension/a2ui/v0.8', 'description': 'Provides agent driven UI using the A2UI JSON format.'}]}
