...
def test_topic_matching():
    ...
    test_cases = [('reproductive system', '34-', True), ('endocrine system', '28-', True), ('meiosis', '11-1', True), ('meitosis', '11-1', True), ('ATP', '6-4', True), ('cell energy', '6-', True), ('photosynthesis', '8-', True), ('how plants make food', '8-', True), ('digestive system', '25-', True), ('nervous system', '26-', True), ('quantum physics', None, False), ('Shakespeare', None, False)]
    passed = 0
    failed = 0
    print('\n' + '=' * 60)
